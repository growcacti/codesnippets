...
Needs edits to understand what is what
...
class App():
    ...
    def open_file(self):
        ...
        self.textWidget.insert(tk.END, text_value)
...
class Tab(Frame):
    ...
    def save_tab(self):
        ...
        print(self.textWidget.get("1.0", tk.END))

        file = open(filedialog.asksaveasfilename() + '.txt', 'w+')

        file.write(self.textWidget.get("1.0", tk.END))
...
SR ADV ENGINEERING TECHNCIAN

Lab Phone 480-441-5960     Cell 602-376-2119
