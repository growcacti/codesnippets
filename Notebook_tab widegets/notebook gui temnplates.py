...
e1 = tk.StringVar()
Entry(f1, textvariable=e1, bg="yellow").grid(column=0, row=3)
Label(f1, text="label1").grid(column=0, row=4)
e2 = tk.StringVar()
Entry(f1, textvariable=e2, bg="yellow").grid(column=0, row=5)

cb = ttk.Combobox(f1, state="readonly", values=("a", "b", "c"))
cb.grid(column=1, row=3)
cb.set("a")

cb2 = ttk.Combobox(f1, values=("e", "f", "g"))
