...
class Button2App:
    def __init__(self, master):
        ...
        self.checkbutton.config(
            variable=self.checkme,
            onvalue="I am checked!!",
            offvalue="Waiting for someone to check me!",
        )
        ...
        self.radiobutton1 = ttk.Radiobutton(
            master, text="Paper1", variable=self.papertype, value="Robotics Research"
        )
